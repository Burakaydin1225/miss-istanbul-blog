...
import { RenewSubscriptionForm } from "@/app/panel/ilanlar/[id]/RenewSubscriptionForm";
import {
  AnalyticsEventType,
...
function getSubscriptionStatus(
  ...
  if (
    ...
    return {
      label: "Süresi doldu",
      description:
        "Bu ilanın aboneliği sona erdi. Ödeme alınmadan yeniden yayınlanmaz.",
      badgeClassName:
    ...
    <section>
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {canEdit ? (
            <Link
              href={`/panel/ilanlar/${product.id}/duzenle`}
          ...
          <section className="overflow-hidden rounded-[24px] bg-white shadow-sm ring-1 ring-black/[0.05]">
            <div className="border-b border-neutral-100 px-5 py-5 sm:px-6">
              ...
              <p className="mt-1 text-xs text-neutral-500">
                İlanın sistemdeki güncel kayıt
                bilgileri
              </p>
            </div>
